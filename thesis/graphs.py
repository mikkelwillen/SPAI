...
sequential = [0.000011, 0.006513, 0.050452, 0.168493,0.374001, 0.458631, 3.530385, 11.977657, 28.161084, 56.214897, 96.528684, 153.856608, 227.295646]
kernel = [0.000010, 0.000010, 0.000010, 0.000010, 0.000011, 0.000010, 0.000028, 0.000012, 0.000017, 0.000023, 0.000188, 0.000038]
plt.plot(matrixSize, sequential, linestyle="-", color="blue", label="Sequential")
plt.plot(matrixSize, kernel, linestyle="-", color="Orange", label="Parallel")
plt.xlabel("Matrix size")
plt.ylabel("Time (s)")
